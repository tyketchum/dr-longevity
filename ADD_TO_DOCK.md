# Add Longevity App to Your Dock

## Your Custom App is Ready! 🎉

I've created a macOS app bundle called **"Longevity App.app"** with a custom purple-to-teal gradient icon featuring a heart rate pulse line.
...
3. Find **"Longevity App.app"**
4. **Drag it to your Dock** (anywhere you like)
5. Done! 🎉

### Method 2: Right-Click in Dock
1. Double-click "Longevity App.app" to launch it
...
**Click the Dock icon** → App opens automatically in your browser!
