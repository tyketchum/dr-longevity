...
To have the dashboard automatically start every time you log in to your Mac:
...
```bash
launchctl unload ~/Library/LaunchAgents/com.longevity.dashboard.plist
```
...
2. Type "start_dashboard.sh"
3. Press Enter

## Create a Desktop Shortcut

1. Right-click on `start_dashboard.sh`
2. Select "Make Alias"
3. Drag the alias to your Desktop
4. Rename it to "Longevity Dashboard"
...
3. Check logs at:
   - `~/Claude/Garmin/dashboard.log`
   - `~/Claude/Garmin/dashboard.error.log`
